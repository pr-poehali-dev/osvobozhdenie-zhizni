  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      <header className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="container mx-auto flex items-center justify-between py-4 px-4 md:px-8">
          ...
          <nav className="hidden md:flex space-x-8 text-sm font-medium">
            <a href="#benefits" className="text-gray-700 hover:text-purple-700 transition-colors">Преимущества</a>
            <a href="#science" className="text-gray-700 hover:text-purple-700 transition-colors">Научный подход</a>
            <a href="#testimonials" className="text-gray-700 hover:text-purple-700 transition-colors">Отзывы</a>
            <a href="#author" className="text-gray-700 hover:text-purple-700 transition-colors">Об авторе</a>
          </nav>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className={`space-y-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                ...
                <span className="block text-purple-700 mt-2">без лекарств и операций</span>
              </h1>
              <p className="text-xl text-gray-700">
                Адаптивно функциональная гимнастика на тренажёре «Ось Жизни» — ваш короткий путь к омоложению, источнику энергии молодости.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Button className="bg-purple-600 hover:bg-purple-700 text-lg px-8 py-6">
                  Записаться на первое занятие
                </Button>
                <Button variant="outline" className="border-purple-300 text-purple-800 hover:bg-purple-50 text-lg px-8 py-6">
      ...
      <section id="problems" className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-3xl mx-auto mb-12 text-center">
            ...
            <p className="text-gray-600">Многие сталкиваются с этими проблемами ежедневно, не подозревая, что от них можно избавиться без таблеток и операций</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: 'BatteryLow', title: 'Постоянная усталость и сонливость' },
              ...
              { icon: 'AlarmClock', title: 'Стресс, раздражительность, апатия' },
              { icon: 'BadgeAlert', title: 'Сколиоз, искривления позвоночника' },
            ].map((item, index) => (
              <div key={index} className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Эти симптомы — не приговор, а сигнал, что пора действовать!</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="mt-12 text-center">
            <Button variant="outline" className="text-lg border-purple-300 text-purple-800 hover:bg-purple-50">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold mb-12 text-center">Пробовали эти методы?</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { method: 'Массажи, йога, медитации', result: 'без результата' },
              { method: 'Операции, уколы, гормоны', result: 'дорого и опасно' },
              { method: 'Блокады, таблетки, приборы', result: 'временно снимают симптомы' },
          ...
          <div className="mt-12 p-8 bg-purple-100 rounded-xl text-center">
            <h3 className="text-2xl font-bold mb-4">Мы знаем, как вновь сделать вас молодыми, энергичными и активными</h3>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              За одну программу, опираясь лишь на научные открытия скрытых ресурсов вашего тела, о которых знала лишь элита!
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="science" className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="max-w-3xl mx-auto mb-12 text-center">
            ...
            <p className="text-gray-600">Наша методика основана на фундаментальных научных открытиях</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="h-16 w-16 rounded-full bg-purple-100 flex items-center justify-center text-purple-800 text-2xl font-bold mb-4">1</div>
              <h3 className="font-bold text-xl mb-3">Пьезоэлектрический эффект в костях</h3>
              <p className="text-gray-600">Открытие 1957 года, Ивао Ясуда: кости генерируют электрический сигнал при механическом давлении, стимулируя регенерацию.</p>
            </div>
            
            <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="h-16 w-16 rounded-full bg-purple-100 flex items-center justify-center text-purple-800 text-2xl font-bold mb-4">2</div>
              <h3 className="font-bold text-xl mb-3">Закон Вольфа</h3>
              <p className="text-gray-600">Кости укрепляются при механической нагрузке, в 15 раз превышающей вес тела, активируется рост костной ткани и выделение гормонов.</p>
            </div>
            
            <div className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
              <div className="h-16 w-16 rounded-full bg-purple-100 flex items-center justify-center text-purple-800 text-2xl font-bold mb-4">3</div>
              <h3 className="font-bold text-xl mb-3">Практическое применение</h3>
              <p className="text-gray-600">С 1997 г. институты Harvard, Emory и другие создали фитнес-программы, доказав эффективность укрепления костной ткани.</p>
            </div>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-purple-100 to-indigo-50">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold mb-12 text-center">Кому и когда нужно?</h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: 'Shield', title: 'Военным', desc: 'Мобилизация скрытых ресурсов организма при реабилитации' },
              { icon: 'Medal', title: 'Спортсменам', desc: 'Быстрое восстановление после травм, ушибов, растяжений' },
              { icon: 'Car', title: 'Водителям', desc: 'Исправление тазовой деформации и шейно-воротниковой зоны' },
              { icon: 'Laptop', title: 'Офисным работникам', desc: 'При нервных истощениях, стрессах и депрессиях' },
              { icon: 'Heart', title: 'Людям с избыточным весом', desc: 'Нормализация гормонального фона и метаболизма' },
              { icon: 'Activity', title: 'При травмах', desc: 'Способствует ускорению регенеративных процессов' },
              { icon: 'Baby', title: 'Детям и подросткам', desc: 'Исправление осанки, профилактика сколиоза' },
              { icon: 'Heart', title: 'Пожилым людям', desc: 'Возвращаем активность суставам, сохраняем подвижность' },
            ].map((item, index) => (
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Что такое гимнастика и тренажер "Ось Жизни"</h2>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-purple-900 to-transparent p-6">
                ...
                <p className="text-purple-100">Автор АФГ гимнастики и тренажера «Ось Жизни»</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="benefits" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold mb-12 text-center">Что дают занятия?</h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: 'Brain', title: 'Перезагрузка нервной системы', desc: 'Расслабление и прилив сил' },
              { icon: 'Shield', title: 'Усиление иммунитета', desc: 'На уровне ДНК' },
              { icon: 'Droplets', title: 'Гормональный фон', desc: 'Возвращается к молодым показателям' },
              { icon: 'Bone', title: 'Регенерация костей', desc: 'И соединительной ткани' },
              { icon: 'Snowflake', title: 'Коллаген', desc: 'Восстанавливает суставы и гибкость' },
              { icon: 'Droplets', title: 'Лимфатическая система', desc: 'Очищается' },
              { icon: 'Smile', title: 'Гормоны радости', desc: 'Мгновенно поднимают настроение' },
              { icon: 'Zap', title: 'Прилив энергии', desc: 'Уже во время тренировки!' },
            ].map((item, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="p-3 inline-flex rounded-full bg-purple-100 text-purple-700 mb-3">
                  <Icon name={item.icon} className="h-6 w-6" />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6">Принцип воздействия тренажёра «Ось Жизни»</h2>
              <div className="space-y-4">
                {[
            ...
            <div className="bg-purple-50 rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-6 text-purple-800">Уникальность влияния тренажера</h3>
              <div className="space-y-4">
                <p className="text-gray-700">
                  Основан на естественных ресурсах тела и природных механизмах. В отличие от традиционных методов лечения, которые часто требуют длительного времени, хирургического вмешательства или медикаментов, тренажёр «Ось Жизни» предлагает:
                </p>
                {[
      ...
      <section id="testimonials" className="py-16 bg-purple-50">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold mb-12 text-center">Реальные истории</h2>
          ...
          <Tabs defaultValue="elder" className="w-full">
            ...
            <TabsContent value="elder" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  {
                    quote: 'Я снова бегаю с внуком и сплю всю ночь без боли. Вы подарили мне вторую молодость!',
                    name: 'Владимир, 62 года',
                    role: 'военный пенсионер'
                  },
                  {
                    quote: 'За 3 занятия исчезла «холка», подтянулась кожа лица, а после программы прошли боли в кистях.',
                    name: 'Вера, 67 лет',
                    role: 'владелец сети ювелирных магазинов'
                  },
                  {
                    quote: 'После 1 занятия давление снизилось с 150/130 до 130/110, после полного курса ушла боль в шее, повысилась жизненная энергия.',
                    name: 'Юрий, 77 лет',
            ...
            <TabsContent value="middle" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  {
                    quote: 'После первой тренировки улучшился сон, а после курса исправилась осанка, ушёл горб.',
                    name: 'Дмитрий, 55 лет',
                    role: 'проектировщик'
                  },
                  {
                    quote: 'Пройдя полный курс, у меня восстановилась чувствительность половины тела, которой не было уже полтора года после инсульта.',
                    name: 'Вероника, 66 лет',
                    role: 'владелец юридической компании'
                  },
                  {
                    quote: 'В голове — полная тишина, ощущение прозрения и бодрости. После курса — ощущение, что я лечу по жизни на новой энергии.',
                    name: 'Иван, 41 год',
                    role: 'бизнесмен'
                  },
                ].map((testimonial, index) => (
            ...
            <TabsContent value="young" className="mt-0">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  {
                    quote: 'Погрузилась в депрессию, потеряла смысл жизни и работу. После первого упражнения почувствовала прилив энергии и вдохновения.',
                    name: 'Анастасия, 26 лет',
                    role: 'дизайнер'
                  },
                  {
                    quote: 'Впервые за долгое время почувствовал уверенность и контроль. Навел порядок в отношениях и в работе.',
                    name: 'Дмитрий, 35 лет',
                    role: 'инженер'
                  },
                  {
                    quote: 'На грани выгорания и разочарования. После курса вернулась к жизни, обрела уверенность, новых клиентов и творческое вдохновение.',
                    name: 'Полина, 28 лет',
                    role: 'фрилансер'
                  },
                ].map((testimonial, index) => (
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <p className="text-lg text-purple-800 mb-4">Автор АФГ гимнастики и тренажера «Ось Жизни»</p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              { 
                ...
                desc: 'Укрепляются кости, связки, суставы, улучшается работа систем' 
              },
            ].map((item, index) => (
          ...
          <div className="mt-12 bg-purple-100 rounded-xl p-8">
            <h3 className="text-2xl font-bold mb-6 text-center">У 92% занимающихся:</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
        ...
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            {[
              ...
              <div key={index} className="bg-white/10 backdrop-blur-md rounded-xl p-4 flex items-start gap-3">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <h2 className="text-3xl font-bold mb-12 text-center">Нас рекомендуют</h2>
            ...
            {[
              {
                ...
                details: 'Кандидат технических наук, доктор экономических наук, профессор. Автор серии книг: Концепция Общественной Безопасности, Концептуальная власть и десятки других книг в сфере экономики, политики, управления.'
              },
              {
                name: 'Борис Алексеевич Семенов',
                role: 'Советский российский живописец, график',
                details: 'Член Санкт-Петербургского Союза художников, представитель ленинградской школы живописи. Академик Российской Академии естественных наук.'
              },
            ].map((person, index) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8">
          <div className="bg-white rounded-xl p-8 shadow-md">
            <h2 className="text-3xl font-bold mb-6 text-center">Ваш ключ к новым возможностям!</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-xl font-semibold mb-4">Хотите расширить возможности вашего бизнеса или приобрести тренажер для дома?</h3>
                <p className="text-gray-700 mb-6">
                  Вы — профессионал в сфере фитнеса, массажа, мануальной терапии или оздоровления? Хотите предложить своим клиентам уникальные методы восстановления и укрепления организма, которые гарантируют быстрый эффект и высокий уровень удовлетворенности?
                </p>
                <p className="font-semibold text-purple-800 mb-6">
                  У нас есть решение — откройте свой Центр Жизни или купите тренажер для домашнего использования, освоив гимнастику для самостоятельной практики!
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-gray-400">Центр омоложения</span>
                </div>
              </div>
              <p className="text-gray-400 text-sm">
                Адаптивно функциональная гимнастика, на запатентованном тренажёре «Ось Жизни» ваш короткий путь к омоложению.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="#science" className="hover:text-white transition-colors">Научный подход</a></li>
                <li><a href="#testimonials" className="hover:text-white transition-colors">Отзывы</a></li>
                <li><a href="#author" className="hover:text-white transition-colors">Об авторе</a></li>
              </ul>
            </div>
